        ...
        return {
            ...
            controller: function ($scope, $ionicLoading) {
                $scope.$watch('data', function () {
                    ...
                    function getTooltipFormatter(mode) {
                        ...
                        return function (info) {
                            ...
                            return [
                                ...
                                '2017年6月: &nbsp;&nbsp;' + amount + '<br>',
                                '2017年7月: &nbsp;&nbsp;' + perHousehold + '<br>',
                                // '2011 Amount: &nbsp;&nbsp;' + amount2011 + '<br>',
                                '比上月增长: &nbsp;&nbsp;' + change
                                // '<div>'+'中钢集团'+'</div>',
                                // '2017年6月:￥765,258,653'+'<br>',
                                // '2017年7月:￥765,258,653'+'<br>',
                                // '比上月增长：50%'+'<br>'
                            ].join('');
                        };
                    }
                    ...
                    var modes = ['煤炭', '矿粉', '耐火材料', '合金', '铁合金', '钢铁'];
